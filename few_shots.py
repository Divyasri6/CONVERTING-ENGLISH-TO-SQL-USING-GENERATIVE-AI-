few_shots = [
    {
        ...
        'SQLQuery': "SELECT Data_Value FROM health_data WHERE LocationName = 'Bellwood' AND Measure = 'Current asthma among adults aged >=18 years' AND Data_Value_Type = 'Crude prevalence';",
        'SQLResult': "Result of the SQL query",
        'Answer': "11"
    },
    {
        'Question': "List all the locations where the prevalence of stroke is above 7%.",
        'SQLQuery': "SELECT LocationName FROM health_data WHERE Measure = 'Stroke among adults aged >=18 years' AND Data_Value > 3;",
        'SQLResult': "Result of the SQL query",
    ...
    },
    {
        ...
        'SQLQuery': "SELECT LocationName, MAX(Data_Value) AS HighestPrevalenceOfObesity FROM health_data WHERE Measure = 'Obesity among adults aged >=18 years' GROUP BY LocationName ORDER BY HighestPrevalenceOfObesity DESC LIMIT 10;",
        'SQLResult': "Result of the SQL query",
    ...
    },
    {
        ...
        'SQLQuery': "SELECT LocationName FROM health_data WHERE Measure = 'Depression among adults aged >=18 years' AND Data_Value > 10;",
        'SQLResult': "Result of the SQL query",
